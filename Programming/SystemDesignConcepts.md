...
Hierarchical and decentralized naming system for computer and services connected to the Internat. It translateds the domain name (e.g. www.example.com) into a IP address (e.g. 93.184.216.34)
...
**Inter-Process Communication (IPC)** mechanisms allows for the process to talk to each other, still having isolated address states.
